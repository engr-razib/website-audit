  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-200 dark:border-slate-800/80 pb-6 transition-colors">
        ...
        <div className="inline-flex rounded-xl bg-slate-100 dark:bg-slate-900 p-1 border border-slate-300 dark:border-slate-800 self-start md:self-auto transition-colors">
          <button
        ...
        <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
          <Tabs defaultValue={submittedFindingValue ? "matches" : "fonts"}>
            ...
            <TabsContent value="json">
              <div className="rounded-xl border border-slate-300 dark:border-slate-800 bg-slate-900 dark:bg-slate-950 p-4 max-h-96 overflow-auto">
