...
export function DownloadBar({ jobId }: DownloadBarProps) {
  ...
  return (
    <div className="p-4 rounded-xl border border-emerald-800/40 bg-gradient-to-r from-emerald-950/40 via-slate-900 to-slate-900 flex flex-col sm:flex-row items-center justify-between gap-4">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h4 className="text-sm font-semibold text-white">Full Audit Complete & Ready to Download</h4>
