...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "default", size = "default", ...props }, ref) => {
    ...
    const variants = {
      ...
      destructive: "bg-red-600/90 text-white hover:bg-red-600 shadow-md",
      outline: "border border-slate-700 bg-slate-900/50 text-slate-200 hover:bg-slate-800 hover:text-white border-slate-700/80",
